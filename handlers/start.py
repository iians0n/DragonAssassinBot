...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_admin(user_id):
        help_text += (
            ...
            "• /setteam [1-4] [players...] - Assign players to a team\n"
            "• /toggleteammode - Toggle auto/manual team assignment\n"
            "• /revive [name] - Revive a player\n"
            "• /revertkill [name] - Revert a kill (undo stats & points)\n"
